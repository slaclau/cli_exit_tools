...
long_description = "functions to exit an cli application properly"
...
setup_kwargs["description"] = "functions to exit an cli application properly"
...
setup_kwargs["entry_points"] = {"console_scripts": ["cli_exit_tools = cli_exit_tools.cli_exit_tools_cli:cli_main"]}
